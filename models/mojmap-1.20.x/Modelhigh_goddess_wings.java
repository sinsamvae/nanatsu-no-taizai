...
public class Modelhigh_goddess_wings<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "high_goddess_wings"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = Body.addOrReplaceChild("bone", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-1.3964F, 1.0F, 2.4036F, 0.0F, -0.3491F, 0.0F));
		...
		PartDefinition bone2 = Body.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.7086F, -1.0112F, 4.2157F, 0.0F, 0.2618F, 0.0F));
		...
		PartDefinition cube_r22 = bone2.addOrReplaceChild("cube_r22",
		...
		PartDefinition cube_r24 = bone2.addOrReplaceChild("cube_r24",
		...
		PartDefinition cube_r25 = bone2.addOrReplaceChild("cube_r25",
		...
		PartDefinition Body_r2 = bone2.addOrReplaceChild("Body_r2",
		...
		PartDefinition bone3 = Body.addOrReplaceChild("bone3", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-5.7248F, 8.4379F, 7.9621F, 0.0F, 0.1309F, 0.0F));
		...
		PartDefinition Body_r3 = bone3.addOrReplaceChild("Body_r3",
				CubeListBuilder.create().texOffs(3, 4).addBox(0.0F, -5.0F, -2.0F, 0.0F, 22.0F, 10.0F,
						new CubeDeformation(0.0F)),
