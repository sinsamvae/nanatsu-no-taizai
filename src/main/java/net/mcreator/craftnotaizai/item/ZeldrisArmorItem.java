...
public abstract class ZeldrisArmorItem extends ArmorItem {
	public ZeldrisArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends ZeldrisArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/zeldris_armor.png";
		}
	}

	public static class Chestplate extends ZeldrisArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends ZeldrisArmorItem {
		public Leggings() {
