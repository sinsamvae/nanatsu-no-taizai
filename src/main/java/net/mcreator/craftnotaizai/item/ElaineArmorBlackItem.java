...
public abstract class ElaineArmorBlackItem extends ArmorItem {
	public ElaineArmorBlackItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends ElaineArmorBlackItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/elaine_black_dress.png";
		}
	}

	public static class Leggings extends ElaineArmorBlackItem {
		public Leggings() {
