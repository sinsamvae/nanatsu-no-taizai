...
public abstract class EscanorArmor2Item extends ArmorItem {
	public EscanorArmor2Item(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends EscanorArmor2Item {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/escanor_full_armor.png";
		}
	}

	public static class Leggings extends EscanorArmor2Item {
		public Leggings() {
