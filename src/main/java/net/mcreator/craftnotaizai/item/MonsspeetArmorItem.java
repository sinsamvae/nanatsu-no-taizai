...
public abstract class MonsspeetArmorItem extends ArmorItem {
	public MonsspeetArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends MonsspeetArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/monspeet_armor.png";
		}
	}

	public static class Leggings extends MonsspeetArmorItem {
		public Leggings() {
