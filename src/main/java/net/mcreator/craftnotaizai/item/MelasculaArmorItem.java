...
public abstract class MelasculaArmorItem extends ArmorItem {
	public MelasculaArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends MelasculaArmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/melascula_armor.png";
		}
	}

	public static class Leggings extends MelasculaArmorItem {
		public Leggings() {
