...
public abstract class EstarossaarmorItem extends ArmorItem {
	public EstarossaarmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends EstarossaarmorItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craft_no_taizai:textures/entities/estarossa_armor.png";
		}
	}

	public static class Leggings extends EstarossaarmorItem {
		public Leggings() {
