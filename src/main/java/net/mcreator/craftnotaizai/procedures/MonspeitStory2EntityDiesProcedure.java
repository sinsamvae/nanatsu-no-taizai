...
public class MonspeitStory2EntityDiesProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
			...
			return;
		{
			...
			for (Entity entityiterator : _entfound) {
				if (((entityiterator.getCapability(CraftNoTaizaiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftNoTaizaiModVariables.PlayerVariables())).Story).equals("Story56")) {
