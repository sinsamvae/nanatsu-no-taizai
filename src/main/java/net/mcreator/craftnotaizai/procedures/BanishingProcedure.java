...
public class BanishingProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		entity.getPersistentData().putDouble("angle", 360);
		...
		for (int index0 = 0; index0 < (int) (50 * 10); index0++) {
			entity.getPersistentData().putDouble("angle", (entity.getPersistentData().getDouble("angle") * 2));
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.PINK.get()), (entity.getPersistentData().getDouble("posX")), (entity.getPersistentData().getDouble("posY")), (entity.getPersistentData().getDouble("posZ")), 5,
						0, 0, 0, 0);
			{
