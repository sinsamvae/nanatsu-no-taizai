...
public class VoltaicWhipSkillProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		for (int index0 = 0; index0 < (int) (25 * 10); index0++) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.ELECTRIC_PARTICLES.get()), (entity.getPersistentData().getDouble("posX")), (entity.getPersistentData().getDouble("posY")),
