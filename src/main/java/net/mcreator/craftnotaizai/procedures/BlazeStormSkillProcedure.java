...
public class BlazeStormSkillProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		for (int index0 = 0; index0 < (int) (25 * 10); index0++) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, (entity.getPersistentData().getDouble("posX")), (entity.getPersistentData().getDouble("posY")), (entity.getPersistentData().getDouble("posZ")), 5, 0.4, 0.4, 0.4, 0);
			{
