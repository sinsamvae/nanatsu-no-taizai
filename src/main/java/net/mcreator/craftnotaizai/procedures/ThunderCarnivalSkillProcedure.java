...
public class ThunderCarnivalSkillProcedure {
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = new Object() {
					public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
						AbstractArrow entityToSpawn = new ThunderCarnivalProjectileEntity(CraftNoTaizaiModEntities.THUNDER_CARNIVAL_PROJECTILE.get(), level);
