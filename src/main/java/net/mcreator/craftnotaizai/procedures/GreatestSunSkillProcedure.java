...
public class GreatestSunSkillProcedure {
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = new Object() {
					public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
						AbstractArrow entityToSpawn = new GreatestSunProjectileEntity(CraftNoTaizaiModEntities.GREATEST_SUN_PROJECTILE.get(), level);
