...
public class VenomToxicityProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		entity.getPersistentData().putDouble("posY", (entity.getY() + 1 + entity.getLookAngle().y));
		...
		for (int index0 = 0; index0 < (int) (25 * 10); index0++) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (CraftNoTaizaiModParticleTypes.VENOM_TOXICY.get()), (entity.getPersistentData().getDouble("posX")), (entity.getPersistentData().getDouble("posY")),
						(entity.getPersistentData().getDouble("posZ")), 5, 0.3, 0.3, 0.3, 0);
			{
