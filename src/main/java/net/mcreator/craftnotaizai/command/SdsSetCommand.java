...
import net.mcreator.craftnotaizai.procedures.ChangeMagicThunderProcedure;
...
import net.mcreator.craftnotaizai.procedures.ChangeMagicLudocielArkProcedure;
...
import net.mcreator.craftnotaizai.procedures.ChangeMagicElementProcedure;
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("sds_set").requires(s -> s.hasPermission(1))
				.then(Commands.argument("Player", EntityArgument.players()).then(Commands.literal("Commandment").then(Commands.argument("commandment", StringArgumentType.word()).executes(arguments -> {
					...
					return 0;
				}))).then(Commands.literal("Magic").then(Commands.literal("Elemental").executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
					...
					ChangeMagicElementProcedure.execute(arguments);
					return 0;
					...
					ChangeMagicThunderProcedure.execute(arguments);
					return 0;
				})).then(Commands.literal("ludociel_Ark").executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
					...
					ChangeMagicLudocielArkProcedure.execute(arguments);
					return 0;
				})).then(Commands.literal("Tornado").executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
					...
					ChangeMagicOceanProcedure.execute(arguments);
					return 0;
				})).then(Commands.literal("Lai").executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
