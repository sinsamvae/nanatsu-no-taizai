...
public class CraftNoTaizaiModGameRules {
	...
	public static final GameRules.Key<GameRules.IntegerValue> CRAFT_NO_TAIZAI_ISTAR = GameRules.register("craftNoTaizaiIstar", GameRules.Category.MISC, GameRules.IntegerValue.create(2));
